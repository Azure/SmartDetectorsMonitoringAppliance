        ...
        public async Task<List<ContractsAlert>> RunAsync(SmartDetectorAnalysisRequest request, bool shouldDetectorTrace, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var analysisRequest = new AnalysisRequest(
                    new AnalysisRequestParameters(resources, request.Cadence, request.AlertRuleResourceId, request.DetectorParameters), this.analysisServicesFactory, stateRepository);
