...
namespace Microsoft.Azure.Monitoring.SmartDetectors.MonitoringAppliance.Analysis
{
    ...
    public class SmartDetectorRunnerInChildProcess : ISmartDetectorRunner
    {
        ...
        public async Task<AutomaticResolutionCheckResponse> CheckAutomaticResolutionAsync(AutomaticResolutionCheckRequest request, bool shouldDetectorTrace, CancellationToken cancellationToken)
        {
            try
            {
                // Run the child process
                return await this.childProcessManager.RunChildProcessAsync<AutomaticResolutionCheckResponse>(
                    this.GetSmartDetectorExecutablePath(),
                    new SmartDetectorRunnerChildProcessInput { AutomaticResolutionCheckRequest = request },
                    cancellationToken);
            }
            catch (ChildProcessFailedException e)
            {
