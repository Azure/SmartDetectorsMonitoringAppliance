...
namespace Microsoft.Azure.Monitoring.SmartDetectors.MonitoringAppliance.Analysis
{
    ...
    public interface ISmartDetectorRunner
    {
        ...
        Task<AutomaticResolutionCheckResponse> CheckAutomaticResolutionAsync(AutomaticResolutionCheckRequest request, bool shouldDetectorTrace, CancellationToken cancellationToken);
    }
}