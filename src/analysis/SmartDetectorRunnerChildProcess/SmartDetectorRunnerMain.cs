    ...
    public static class SmartDetectorRunnerMain
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                return childProcessManager.RunAndListenToParentAsync<SmartDetectorAnalysisRequest, List<ContractsAlert>>(args, RunSmartDetectorAsync, ConvertExceptionToExitCode).GetAwaiter().GetResult();
            }
            catch (Exception e)
            {
        ...
        private static async Task<List<ContractsAlert>> RunSmartDetectorAsync(SmartDetectorAnalysisRequest request, CancellationToken cancellationToken)
        {
