...
namespace Microsoft.Azure.Monitoring.SmartSignals.Infrastructure.Exceptions
{
    using System;
    ...
    public class AlertRuleStoreException : Exception
    {
        ...
        protected AlertRuleStoreException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
